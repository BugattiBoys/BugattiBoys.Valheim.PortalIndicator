...
DLL=BugattiBoys.Valheim.PortalIndicator/bin/Release/BugattiBoys.Valheim.PortalIndicator.dll
PLUGINS=BugattiBoys.Valheim.PortalIndicator/Package/plugins
README=README.md
...
ZIPDESTINATION="../bin/Release/BugattiBoys.Valheim.PortalIndicator.$VERSION.zip"
